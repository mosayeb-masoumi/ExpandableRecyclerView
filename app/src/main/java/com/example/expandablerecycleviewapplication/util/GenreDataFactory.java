package com.example.expandablerecycleviewapplication.util;
...
//    }
    ...
    public static Genre makeRockGenre() {
        return new Genre("Rock", makeRockArtists(), R.drawable.ic_banjo);
    }

//    public static MultiCheckGenre makeMultiCheckRockGenre() {
//        return new MultiCheckGenre("Rock", makeRockArtists(), R.drawable.ic_banjo);
//    }
//
...
//    }
    ...
    public static Genre makeJazzGenre() {
        return new Genre("Jazz", makeJazzArtists(), R.drawable.ic_banjo);
    }

//    public static MultiCheckGenre makeMultiCheckJazzGenre() {
//        return new MultiCheckGenre("Jazz", makeJazzArtists(), R.drawable.ic_banjo);
//    }
//
...
//    }
    ...
    public static Genre makeClassicGenre() {
        return new Genre("Classic", makeClassicArtists(), R.drawable.ic_banjo);
    }

//    public static MultiCheckGenre makeMultiCheckClassicGenre() {
//        return new MultiCheckGenre("Classic", makeClassicArtists(), R.drawable.ic_banjo);
//    }
//
...
//    }
    ...
    public static Genre makeSalsaGenre() {
        return new Genre("Salsa", makeSalsaArtists(), R.drawable.ic_banjo);
    }

//    public static MultiCheckGenre makeMultiCheckSalsaGenre() {
//        return new MultiCheckGenre("Salsa", makeSalsaArtists(), R.drawable.ic_banjo);
//    }
//
